...
class veeamagent(
  ...
  Hash $config_entries,
  Optional[String] $gpgkey_ca_ensure,
  Optional[String] $gpgkey_ca_local,
  Optional[String] $gpgkey_ca_source,
  Optional[String] $gpgkey_ensure,
  Optional[String] $gpgkey_local,
  Optional[String] $gpgkey_source,
  Optional[String] $package_ensure,
  Optional[String] $package_name,
  Optional[String] $repo_path,
  Optional[String] $repo_template,
